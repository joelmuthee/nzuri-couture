...
function posReceiptText(s) {
  ...
  return [`*Nzuri Couture* receipt`, `${s.name} (Size ${s.size}) x${s.qty}`, `Total: ${fmtKsh(total)}. Paid by ${s.paymentMethod === 'mpesa' ? 'M-Pesa' : 'Cash'}.`, `Thank you for shopping with us. Kilimani, Nairobi.`].join('\n');
}
